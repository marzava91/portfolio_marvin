...
class _HeaderSectionWebState extends State<HeaderSectionWeb>
  ...
  void initState() {
    ...
    // Asegura que los textos empiecen sin mostrar
    showPosition = false;
    showPosition2 = false;
  }
  ...
  Widget build(BuildContext context) {
    ...
    final firstNameColor = Theme.of(context).colorScheme.onSurface.withOpacity(0.3);
          ...
          Column(
            ...
            children: [
              Stack(
                children: [
                  Container(
                    margin: EdgeInsets.only(top: heightOfStack * 0.05, left: Sizes.PADDING_60,),
